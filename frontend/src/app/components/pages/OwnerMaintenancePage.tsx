...
import { useApp, MaintenanceRequest, MaintenanceCost } from '../../context/AppContext';
...
import { Wrench, DollarSign, Clock, CheckCircle, AlertCircle, Edit } from 'lucide-react';
                ...
                <div className="border rounded-lg p-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="pt-2 border-t flex justify-between font-semibold">
                      <span>Total:</span>
                      <span>${getTotalCost(selectedRequest.id)}</span>
                    </div>
                  </div>
                </div>
              )}
