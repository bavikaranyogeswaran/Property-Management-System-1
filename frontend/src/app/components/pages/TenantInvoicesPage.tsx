...
import { useApp, Receipt as ReceiptType } from '../../context/AppContext';
  ...
  const stats = [
    {
      ...
      subtitle: `$${pendingInvoices.reduce((sum, i) => sum + i.amount, 0).toLocaleString()}`,
      color: 'bg-orange-50 text-orange-700',
    },
    {
      label: 'Overdue',
      value: overdueInvoices.length,
      subtitle: `$${overdueInvoices.reduce((sum, i) => sum + i.amount, 0).toLocaleString()}`,
      color: 'bg-red-50 text-red-700',
    },
    {
      label: 'Paid',
      value: paidInvoices.length,
      subtitle: `$${paidInvoices.reduce((sum, i) => sum + i.amount, 0).toLocaleString()}`,
      color: 'bg-green-50 text-green-700',
    },
    {
      label: 'Total Spent',
      value: `$${paidInvoices.reduce((sum, i) => sum + i.amount, 0).toLocaleString()}`,
      subtitle: 'All time',
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700">
                  Total overdue amount: ${overdueInvoices.reduce((sum, i) => sum + i.amount, 0).toLocaleString()}
                </p>
              </div>
            </div>
          </CardContent>
