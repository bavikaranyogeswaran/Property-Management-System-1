...
export function AnalyticsPage() {
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      subtitle: `Avg: $${avgMaintenanceCost} per request`,
      icon: Wrench,
      color: 'text-red-600',
      bgColor: 'bg-red-50',
    },
                  ...
                  <tbody>
                    {propertyRevenueData.map((prop, index) => (
                      <tr key={index} className="border-b last:border-0">
                        ...
                        <td className="py-3 font-semibold">${prop.revenue.toLocaleString()}</td>
                        <td className="py-3">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                            prop.units === 0 ? 'bg-gray-100 text-gray-600' :
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-semibold">${totalMaintenanceCost.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between items-center mt-2">
                      <span className="text-sm text-gray-600">Average per Request</span>
                      <span className="font-semibold">${avgMaintenanceCost}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-3 gap-3">
                    <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <p className="text-xs text-gray-600 mt-1">${invoices.filter(i => i.status === 'paid').reduce((s, i) => s + i.amount, 0).toLocaleString()}</p>
                    </div>
                    <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                      ...
                      <p className="text-xs text-gray-600 mt-1">${pendingPayments.toLocaleString()}</p>
                    </div>
                    <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                      ...
                      <p className="text-xs text-gray-600 mt-1">
                        ${invoices.filter(i => i.status === 'pending' && new Date(i.dueDate) < new Date()).reduce((s, i) => s + i.amount, 0).toLocaleString()}
                      </p>
                    </div>
                  </div>
                  <div className="pt-4 border-t">
                  ...
                  {[
                    ...
                    <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-xs text-gray-600 mt-1">${stat.amount.toLocaleString()}</p>
                      </div>
                      <span className={`px-3 py-1 rounded-full font-semibold ${stat.color}`}>
                        {stat.value}
                      </span>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {properties.map((property) => {
                      ...
                      return (
                        <tr key={property.id} className="border-b last:border-0">
                          ...
                          <td className="py-3 font-semibold">${propCost.toLocaleString()}</td>
                          <td className="py-3">${propAvg}</td>
                        </tr>
                      );
                    })}
                    <tr className="font-semibold bg-gray-50">
                      ...
                      <td className="py-3">${totalMaintenanceCost.toLocaleString()}</td>
                      <td className="py-3">${avgMaintenanceCost}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between p-2 bg-gray-50 rounded">
                      ...
                      <span className="font-semibold">${expectedMonthlyRevenue.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between p-2 bg-green-50 rounded">
                    ...
                    <div className="flex justify-between p-2 bg-orange-50 rounded">
                      <span className="text-sm text-orange-900">Pending</span>
                      <span className="font-semibold text-orange-700">${pendingPayments.toLocaleString()}</span>
                    </div>
                    ...
                    {tenants.map((tenant) => {
                      ...
                      return (
                        <tr key={tenant.id} className="border-b last:border-0">
                          ...
                          <td className="py-3 font-semibold">${tenantTotal.toLocaleString()}</td>
                        </tr>
                      );
                    })}
                  </tbody>
