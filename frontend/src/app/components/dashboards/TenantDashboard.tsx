...
export function TenantDashboard() {
  ...
  const stats = [
    {
      title: 'Current Rent',
      value: currentLease ? `$${currentLease.monthlyRent}` : 'N/A',
      subtitle: 'Monthly',
      icon: Home,
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold mt-1">${currentLease.monthlyRent}</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700">
                  Total amount: ${overdueInvoices.reduce((sum, inv) => sum + inv.amount, 0)}
                </p>
              </div>
            </div>
          </CardContent>
