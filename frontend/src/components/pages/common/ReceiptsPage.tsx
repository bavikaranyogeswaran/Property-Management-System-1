  ...
  const handleViewReceipt = (receipt: Receipt) => {
    ...
    setSelectedReceipt({
      ...
      propertyName:
        ...
        property?.name ||
        (invoice ? 'Property #' + (invoice.propertyName || 'N/A') : 'N/A'),
      unitNumber:
        receipt.unitNumber ||
        unit?.unitNumber ||
        (invoice ? invoice.unitNumber || 'N/A' : 'N/A'),
      paymentMethod: receipt.paymentMethod || payment?.paymentMethod || 'N/A',
      paymentDate:
        receipt.paymentDate || (payment ? payment.paymentDate : 'N/A'),
      description:
        receipt.description ||
        (invoice
          ? invoice.description || 'Payment Receipt'
          : 'Payment Receipt'),
    });
  };
                      ...
                      <TableRow key={receipt.id}>
                        ...
                        <TableCell className="align-middle h-14">
                          ...
                          <div className="text-xs text-gray-500">
                            {new Date(receipt.generatedDate).toLocaleTimeString(
                              'en-US',
                              {
                                hour: '2-digit',
                                minute: '2-digit',
                        ...
                        {user?.role !== 'tenant' && (
                          <TableCell className="align-middle h-14">
                            <div className="text-sm">
                              ...
                              <div className="text-xs text-gray-500">
                                {receipt.tenantEmail || tenant?.email}
                              </div>
                            </div>
                          </TableCell>
                        )}
                        <TableCell className="align-middle h-14">
                          <div className="text-sm">
                            ...
                            <div className="text-xs text-gray-500">
                              ...
                              {receipt.unitNumber ||
                                unit?.unitNumber ||
                                (invoice ? invoice.unitNumber : 'N/A')}
                            </div>
                          </div>
                        </TableCell>
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        {searchTerm
                          ...
                          : 'Receipts will appear here after payments are verified'}
                      </p>
                    </TableCell>
                  </TableRow>
                )}
