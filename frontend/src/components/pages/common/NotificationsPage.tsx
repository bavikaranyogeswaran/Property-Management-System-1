...
import { Bell, AlertTriangle, FileText, Check, Info, Wrench, CreditCard } from 'lucide-react';
...
export function NotificationsPage() {
    ...
    const getIcon = (type: string) => {
        switch (type) {
            ...
            case 'lease_expiring': return FileText;
            default: return Bell;
        }
    };
        ...
        <div className="space-y-6 max-w-5xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Stay updated with important system alerts</p>
                </div>
                        ...
                        return (
                            ...
                            >
                                <div className="p-4 flex gap-4 items-start">
                                    <div className={`p-2 rounded-full shrink-0 ${isUnread ? 'bg-blue-50' : 'bg-gray-100'}`}>
                                        <Icon className={`size-5 ${isUnread ? 'text-blue-600' : 'text-gray-500'}`} />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start gap-2">
                                            <div>
                                                ...
                                                <Badge variant="outline" className={`mt-1 text-[10px] uppercase tracking-wider ${getSeverityColor(notification.severity)}`}>
                                        ...
                                        <p className={`text-sm mt-2 ${isUnread ? 'text-gray-800' : 'text-gray-500'}`}>
