...
import { Building2, CheckCircle, ArrowRight, Star, Users, Shield } from 'lucide-react';
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
                            Find Your Perfect <span className="text-blue-600">Dream Home</span>
                        </h1>
                        <p className="text-lg text-gray-600 leading-relaxed">
                            Experience modern living with our premium properties.
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        ...
                        <p className="text-gray-600">
                            We provide a complete property management solution that makes renting easy and living comfortable.
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8 mb-8 border-b border-gray-800 pb-8">
                        <div>
                            ...
                            <p className="text-gray-400">Making property management simple and efficient for everyone.</p>
                        </div>
                        <div>
