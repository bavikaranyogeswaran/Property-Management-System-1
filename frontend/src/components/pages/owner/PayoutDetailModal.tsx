            ...
            <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                      ...
                      <p className="font-mono text-sm font-semibold">
                        {data.summary.bankReference || 'N/A'}
                      </p>
                    </div>
                    <div>
                      <span className="text-xs font-bold text-gray-400 uppercase">
                      ...
                      <div className="mt-1">
                        <Badge
                          variant={
                            data.summary.status === 'acknowledged'
                              ? 'default'
                              : data.summary.status === 'disputed'
                                ? 'destructive'
                                : 'secondary'
                          }
                        >
                        ...
                        <TableRow key={item.cost_id}>
                          ...
                          <TableCell>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <Badge
                                variant="outline"
                                className="text-[10px] h-4 py-0 px-1 font-mono uppercase"
                              >
                                {item.bill_to || 'owner'}
                              </Badge>
                              <div className="text-[10px] text-muted-foreground italic line-clamp-1 max-w-[250px]">
                                {item.description}
                              </div>
                            </div>
                          </TableCell>
                      ...
                      {data.expenses.length === 0 && (
                        <TableRow>
                          <TableCell
                            ...
                            className="text-center py-12 text-muted-foreground italic"
                          >
                            No expense deductions for this period.
                          </TableCell>
                        </TableRow>
                      )}
                    </TableBody>
              ...
              <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl flex gap-3 text-sm text-blue-700 shadow-inner">
                ...
                <p className="leading-relaxed">
                  These records capture all <b>verified</b> rent payments and{' '}
                  <b>active</b> maintenance costs as of the payout generation
                  date. For certified tax purposes, please use the CSV export.
                </p>
              </div>
            </div>
          ) : null}
